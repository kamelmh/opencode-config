...
A skill for OpenCode that helps you write, update, and improve README files tailored to your specific project type and audience.
...
OpenCode: What type of project is this - open source, personal, or internal?

User: Open source, it's a Node.js package

OpenCode: [Uses OSS template, asks about installation, usage, and contributing]
```
...
OpenCode: [Reads current README, identifies where to add the new feature,
...
OpenCode: [Compares README against package.json, main files, etc.
