...
Refactor bloated agent instruction files (AGENTS.md, COPILOT.md, etc.) to follow **progressive disclosure principles** - keeping essentials at root and organizing the rest into linked, categorized files.
...
└── .opencode/                      # Or docs/agent-instructions/
    ├── typescript.md
    ├── testing.md
    ├── code-style.md
    ├── git-workflow.md
...
- [TypeScript Conventions](.opencode/typescript.md)
- [Testing Guidelines](.opencode/testing.md)
- [Code Style](.opencode/code-style.md)
- [Git Workflow](.opencode/git-workflow.md)
- [Architecture Patterns](.opencode/architecture.md)
```
...
- [TypeScript](.opencode/typescript.md)
```
